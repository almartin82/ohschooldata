...
get_available_years <- function() {
  list(
    min_year = 2007,
    max_year = 2024,
    description = "Ohio ODEW enrollment data is available from 2007 (2006-07 school year) through 2024 (2023-24 school year). Years 2007-2014 use legacy format with varying file structures. Years 2015-present use modern format with consistent ENROLLMENT_BUILDING/DISTRICT files."
  )
}
