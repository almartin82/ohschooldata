...
# ==============================================================================
#
# Functions for caching downloaded ODEW data files to avoid repeated downloads.
#
# ==============================================================================

#' Get the cache directory for ohschooldata
#'
...
get_cache_dir <- function() {
  cache_dir <- file.path(
    rappdirs::user_cache_dir("ohschooldata"),
    "data"
  )
...
#' @param type File type ("raw", "wide", or "tidy")
