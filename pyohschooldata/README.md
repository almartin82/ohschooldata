...
Python wrapper for Ohio school enrollment data.

This is a thin rpy2 wrapper around the [ohschooldata](https://github.com/almartin82/ohschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `ohschooldata` R package installed
...
df_multi = oh.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
